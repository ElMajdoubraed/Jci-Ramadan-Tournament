...
export default function TeamListComponent({ teams, onRefresh }: TeamListProps) {
  ...
  // Réinitialiser le formulaire quand l'équipe sélectionnée change
  useEffect(() => {
    if (selectedTeam) {
  ...
  const handleUpdateTeam = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('Échec de la mise à jour de l\'équipe');
      }
    } catch (error) {
  ...
  // Fonction pour déterminer la couleur de fond pour chaque groupe
              ...
              <tr>
                <td colSpan={7} className="py-8 text-center">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-gray-500 text-lg font-medium">Aucune équipe enregistrée</p>
                    <p className="text-gray-400 text-sm mt-1">Ajoutez votre première équipe pour commencer</p>
                  </div>
                </td>
              </tr>
            )}
          ...
          <div className="flex min-h-screen items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle">
                ...
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                    <h3 className="text-lg font-medium leading-6 text-gray-900">
                      Modifier l'Équipe: {selectedTeam.name}
                    </h3>
              ...
              <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                ...
                >
                  {isUpdating ? 'Enregistrement...' : 'Modifier l\'Équipe'}
                </button>
                <button
                  type="button"
                  onClick={closeModal}
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Êtes-vous sûr de vouloir supprimer l'équipe "{selectedTeam.name}" ? Cette action ne peut pas être annulée et peut affecter les matchs associés.
                      </p>
                    </div>
                  </div>
                </div>
